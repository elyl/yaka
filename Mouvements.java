...
{
    public static final Mouvement RIGHT = new Mouvement(1, 0);
    public static final Mouvement LEFT = new Mouvement(-1, 0);
    public static final Mouvement AHEAD = new Mouvement(0, 1);
